...
DANISH_DEMOCRACY_MODELS_GOLD = [
    ...
    "vote",
    "vote_type",
    # "time" is intentionally excluded: it is an observability-only dimension used as a
    # FK target by the data_engineering models (dagster_run, dagster_asset_materialization,
    # dagster_step_failure). It is not a business dimension for downstream BI consumers.
]
